...
DOXYGEN =doxygen
SOURCES = main.cpp task/subtask.cpp task/task.cpp platform/processor.cpp platform/platform.cpp task/taskset.cpp common/list.cpp analysis/analysis.cpp task/buffer.cpp task/comm.cpp
